...
typedef struct task_type {
    ...
    int8_t    task_ID;
    NRK_STK *Ptos; /* Dalton Banks - changed from void * for C++ compiler */
    NRK_STK *Pbos; /* Dalton Banks - changed from void * for C++ compiler */
    void (*task)();    
...
/* Dalton Banks - redefinition of _nrk_scheduler(void) in nrk_scheduler.h */

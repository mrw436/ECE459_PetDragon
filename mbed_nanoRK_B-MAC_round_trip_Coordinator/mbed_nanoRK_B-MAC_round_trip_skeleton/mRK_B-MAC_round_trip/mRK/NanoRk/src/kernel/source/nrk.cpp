...
/* Dalton Banks - moved implementation of globals to nrk.c and #DEFINEs to nrk.h */
//#include <nrk_defs.h>
#include <nrk_cpu.h>
/* Dalton Banks - added <nrk_timer.h> include for nrk_spin_wait_us() */
#include <nrk_timer.h>
...
void nrk_init()
{
    ...
    i=_nrk_startup_error(); //TODO: check this...
...
#ifdef NRK_WATCHDOG //TODO: check watchdog initialize...
...
int8_t nrk_TCB_init (nrk_task_type *Task, NRK_STK *ptos, NRK_STK *pbos, uint16_t stk_size, void *pext, uint16_t opt)
{
    ...
    nrk_task_TCB[Task->task_ID].errno= NRK_OK;
		...
		nrk_task_TCB[Task->task_ID].task_addr = Task->task;
...
void _nrk_timer_tick(void)
{
    ...
    _nrk_scheduler(); //Abhijeet...to run scheduler
